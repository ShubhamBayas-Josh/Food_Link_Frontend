        ...
        <div className="w-full">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
            <div className="mx-auto max-w-2xl mb-12">
              ...
              <p className="mt-4 text-sm text-gray-500">No Payments required</p>
            </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex flex-col items-center mb-16">
                ...
                <p className="text-center text-gray-600 max-w-3xl text-lg">
                  Service organizations want access to excess food, but there
                  are barriers — locating the excess food, establishing their
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <div className="group bg-white border-2 border-green-400 p-8 rounded-xl text-center shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                  ...
                  <p className="text-gray-600">
                    ...
                    of all food is wasted. In India alone, over{" "}
                ...
                <div className="group bg-white border-2 border-red-400 p-8 rounded-xl text-center shadow-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
                  ...
                  <p className="text-gray-600">
                    If just{" "}
                    <span className="font-bold text-red-500 text-xl">1/3</span>{" "}
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="max-w-4xl mx-auto">
                <div className="bg-gray-50 rounded-2xl p-10 shadow-lg relative">
                  <svg
                    className="absolute text-blue-500 w-16 h-16 -top-8 -left-8 opacity-25"
                    fill="currentColor"
                    viewBox="0 0 32 32"
                    aria-hidden="true"
                  >
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <div className="mt-4 text-center">
                      ...
                      <p className="text-blue-600">Marketer</p>
                    </div>
                  </div>
                </div>
              </div>
